        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <option value="{{ $filiere->id_filiere }}" @if ($filiere->id_filiere == $matiere->id_filiere) selected @endif>{{ $filiere->nom_filiere }}</option>
          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <option value="{{ $prof->id_enseignant }}"  @if ($prof->id_enseignant == $matiere->id_enseignant) selected @endif>{{ $prof->nom_ens }}</option>
            ...
            <div class="form-group">
                ...
                <option value="{{ $semestre->id_semestre }}"  @if ($semestre->id_semestre == $matiere->id_semestre) selected @endif>{{ $semestre->nom_sem }}</option>
