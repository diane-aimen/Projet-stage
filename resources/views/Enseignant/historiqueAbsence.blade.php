            ...
            @foreach($abs as $a)
                <tr> <!-- Move the <tr> tag here -->
                    ...
                    @else
                        <td>Present(e)</td>
                    @endif
                    <td>{{ $a->etudiant['nom_etu']}}</td>
                    <td>{{ $a->seance['date'] }}</td>
                    <td>{{ $a->seance['heure_debut'] }}</td>
                    <td>{{ $a->seance['heure_fin'] }}</td>
                    <td>{{ $a->seance['type'] }}</td>
                    <td>{{ $a->seance->matiere['nom_mat'] }}</td>
                    <td>{{ $a->seance->matiere->filiere['nom_filiere'] }}</td>
                    <td>{{ $a->seance->matiere->semestre['nom_sem'] }}</td>
                </tr>
            @endforeach
        @endforeach
    @endisset
